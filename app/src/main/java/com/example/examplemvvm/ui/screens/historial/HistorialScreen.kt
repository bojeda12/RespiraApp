...
fun Historial() {
    Container(
        ...
        Column(
            ...
            GeneralLbl("Se recomienda realizar una rutina de respiracion en un horario de 6:00PM a 8:00PM",tamano = 16.sp, alineacionTexto = TextAlign.Center)
